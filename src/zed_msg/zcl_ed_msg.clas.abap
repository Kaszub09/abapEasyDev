...
CLASS zcl_ed_msg DEFINITION PUBLIC FINAL CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    CLASS-METHODS:
      get IMPORTING text       TYPE csequence
      ...
      throw   IMPORTING text TYPE csequence
                        v1   TYPE any OPTIONAL
                        v2   TYPE any OPTIONAL
                        v3   TYPE any OPTIONAL
                        v4   TYPE any OPTIONAL
              RAISING   zcx_ed_exception,
      get_from_bapiret2 IMPORTING bapiret2   TYPE bapiret2
                        RETURNING VALUE(msg) TYPE string,
      get_from_bapi_coru_return  IMPORTING bapi_coru_return TYPE bapi_coru_return
                                 RETURNING VALUE(msg)       TYPE string,
      get_from_bdcmsgcoll   IMPORTING bdcmsgcoll TYPE bdcmsgcoll
                            RETURNING VALUE(msg) TYPE string,
      get_from_sy  RETURNING VALUE(msg) TYPE string,
      get_bapiret2_from_sy RETURNING VALUE(bapiret2) TYPE bapiret2.
ENDCLASS.
